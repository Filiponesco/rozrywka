...
import 'package:rozrywka/NewItem/AddBook.dart';
...
class MainPage extends StatelessWidget {
  ...
  void _addNewItems(context, currentPage) {
  ...
  Widget build(BuildContext context) {
    ...
    //it returns empty page when Option.logout
    return Builder(
      builder: (context) => DefaultTabController(
        ...
        child: Scaffold(
          floatingActionButton: FloatingActionButton(
            ...
            onPressed: () {
              _addNewItems(context, currentPage);
            },
          ),
